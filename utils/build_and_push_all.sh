utils/build_and_push.sh gnuradio-pybombs-base Dockerfile boxel/gnuradio-pybombs-base:latest
...
utils/build_and_push.sh rtlamr Dockerfile boxel/rtlamr:latest
utils/build_and_push.sh webwspr Dockerfile boxel/webwspr:latest
utils/build_and_push.sh weewx Dockerfile boxel/weewx:latest
